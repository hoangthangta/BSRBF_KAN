...
# Test on MNIST
We trained the models in **15 epochs on GeForce RTX 3060 Ti** (with other default parameters; see Commands). In general, BSRBF_KAN can converge better than other networks but requires more training time. One can sue dropout to avoid overfitting.
