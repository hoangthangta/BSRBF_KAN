...
In this repo, we use Efficient KAN (https://github.com/Blealtan/efficient-kan/ and FAST-KAN (https://github.com/ZiyaoLi/fast-kan/) to create BSRBF_KAN, which combines B-Spline (**BS**) and Radial Basic Function (**RBF**) for Kolmogorov-Arnold Networks (KANs). Our paper is available at https://arxiv.org/abs/2406.11173 (v2 will be updated in 2 days).
...
| Network | Total Layers | Training Accuracy | Val Accuracy | Macro F1 | Macro Precision | Macro Recall | Training time (seconds) | Params
 ...
 | mlp   | 2 (768, 64, 10) | 99.42 |  97.69 | 97.66 | - | - | 273  | **52512** |
...
## Average of 5 training sessions
 ...
 | mlp | 2 (768, 64, 10) | 99.44 ± 0.01 | **97.62 ± 0.03** | **97.59 ± 0.03** | - | - | 181 |
